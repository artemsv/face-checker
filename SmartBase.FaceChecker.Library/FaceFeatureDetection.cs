...
{
    public class FaceFeatureDetection
    {
        ...
        public void Init()
        {
            //Cv2.NamedWindow("faceCheckerWindow", WindowFlags.AutoSize);
            //Cv2.SetWindowProperty("faceCheckerWindow", WindowPropertyFlags.)
        ...
        public void DetectFeatures()
        {
            ...
            while (true)
            {
                ...
                MarkFeatures(image);
                Cv2.ImShow("faceCheckerWindow", image);
